...
/**
 * TitanTransaction defines a transactional context for a {@link TitanGraph}.
 * Since TitanGraph is a transactional graph database, all interactions with the
 * graph are mitigated by a TitanTransaction.
 * <p/>
...
public interface TitanTransaction extends TitanGraphTransaction {
	 ...
	 * valid Titan vertex id or if a vertex with the given id already exists.
	 * <p/>
	 ...
	 * .
	 * <p/>
	 * Use {@link com.thinkaurelius.titan.core.util.TitanId#toVertexId(long)} to
	 * construct a valid Titan vertex id from a user id.
	 *
	 * @param id
	 ...
	 * {@link TitanTransaction#addVertex(Long, VertexLabel)} in case starVertex
	 * not provided. Otherwise pass starVertex to {@link IDPlacementStrategy}
	 * for better graph partitioning
	 * 
	 * @param id
	 * @param label
	 * @param starVertex
	 * @return
	 */
	public TitanVertex addStarVertex(Long id, VertexLabel label, StarVertex starVertex);
